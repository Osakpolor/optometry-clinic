...
export default async function DashboardPage() {
  ...
  <div>
    ...
    <div className="mb-6 flex items-center justify-between">
      ...
      <p className="text-xs text-muted-foreground hidden sm:block">Auto-refreshes every minute</p>
    </div>
  ...
  <Card>
    <CardContent className="pt-4 pb-4 px-4">
      <p className="text-xs font-medium text-muted-foreground leading-tight">Today's appointments</p>
      <p className="text-3xl sm:text-4xl font-bold mt-1">{todayAppointments?.length ?? 0}</p>
    </CardContent>
  </Card>
</div>

    {/* DOCTOR SECTION — top priority */}
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
      ...
      {/* Follow-ups sidebar — clinically urgent */}
    ...
    {/* RECEPTIONIST SECTION — below the fold */}
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-3 px-4 sm:px-6">
        <div>
