      ...
      <div className="mt-6 flex flex-col gap-4">
        ...
        <Section title="Visual acuity">
          <div className="grid grid-cols-3 gap-2 text-xs text-muted-foreground mb-2">
            <span />
            <span className="font-semibold text-pink-500 text-center">OD (Right)</span>
            <span className="font-semibold text-green-600 text-center">OS (Left)</span>
          </div>
          {[
          ...
          ].filter(([, a, b]) => a || b).map(([label, od, os]) => (
            <div key={label as string} className="grid grid-cols-3 gap-2 border-b border-gray-50 py-2 text-sm last:border-0">
              <span className="text-muted-foreground">{label}</span>
              <span className="text-center font-medium text-pink-700">{od as string || '—'}</span>
              <span className="text-center font-medium text-green-700">{os as string || '—'}</span>
            </div>
          ))}
        ...
        <Section title="Refraction">
          <div className="grid grid-cols-3 gap-2 text-xs text-muted-foreground mb-2">
            <span />
            <span className="font-semibold text-pink-500 text-center">OD</span>
            <span className="font-semibold text-green-600 text-center">OS</span>
          </div>
          {[
        ...
        <div className="mt-2">
          <Link href={`/dashboard/patients/${id}/visits/new`}>
            <Button variant="outline" className="w-full">+ Record another visit</Button>
          </Link>
        </div>
      </div>
    </main>
